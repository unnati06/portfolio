        ...
        <div className="bg-transparent rounded-xl shadow-lg p-6">
          ...
          <form className="mt-6">
            <div className="mb-4">
              ...
              <input
                type="text"
                className="w-full mt-1 p-2 rounded-lg bg-[#0B0B0B] text-gray-300 dark:bg-[#0B0B0B] dark:border-gray-600 dark:text-white"
            ...
            <button
              type="submit"
              className="w-full bg-purple-950 hover:bg-purple-900 text-white font-semibold py-2 rounded-lg transition"
            >
              Send Message
            </button>
          </form>
